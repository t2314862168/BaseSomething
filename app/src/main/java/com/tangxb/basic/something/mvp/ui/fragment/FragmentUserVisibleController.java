...
public class FragmentUserVisibleController {
    ...
    public void resume() {
        if (DEBUG) {
            Log.w(TAG, fragmentName + ": resume, userVisibleHint=" + fragment.getUserVisibleHint());
        }
        if (fragment.getUserVisibleHint()) {
    ...
    public void pause() {
        if (DEBUG) {
            Log.w(TAG, fragmentName + ": pause, userVisibleHint=" + fragment.getUserVisibleHint());
        }
        if (fragment.getUserVisibleHint()) {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (DEBUG) {
            ...
            Log.w(TAG, fragmentName + ": setUserVisibleHint, userVisibleHint=" + isVisibleToUser + ", " + (fragment.isResumed() ? "resume" : "pause") + ", " + parent);
        }
